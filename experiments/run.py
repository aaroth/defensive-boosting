...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=True,
        help=(
            "aggregate OGB, BBM, and OSBoost forecasts before each label is "
